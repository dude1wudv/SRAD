...
#define TRI_VOLUME_DDR_WORDS 262144
...
static_assert(kCols == 256, "tri_384plio TopPL expects 256 columns");
static_assert(kNumLanes == 128, "tri_384plio TopPL expects 128 AIE lanes");
static_assert(kGridDepth * kLanesPerDepth == kNumLanes,
              "lane count must match depth split");
static_assert(kWarmupRows == 4, "tri_384plio TopPL expects 4 warmup rows");
...
#pragma HLS STREAM variable=in0 depth=32
#pragma HLS STREAM variable=in1 depth=32
#pragma HLS STREAM variable=in2 depth=32
#pragma HLS STREAM variable=in3 depth=32
#pragma HLS STREAM variable=in4 depth=32
#pragma HLS STREAM variable=in5 depth=32
#pragma HLS STREAM variable=in6 depth=32
#pragma HLS STREAM variable=in7 depth=32
