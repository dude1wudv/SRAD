...
void hdiff_com(
  ...
  v8int32* in_ms_vert  = (v8int32*)(ms_base + (0 * COL));
  v8int32* in_ms_left  = (v8int32*)(ms_base + (1 * COL));
  v8int32* in_ms_right = (v8int32*)(ms_base + (2 * COL));


  int32_t* out_mask_vert  = mask_base + (0 * kMaskWordsPerRow);
  int32_t* out_mask_left  = mask_base + (1 * kMaskWordsPerRow);
  int32_t* out_mask_right = mask_base + (2 * kMaskWordsPerRow);
