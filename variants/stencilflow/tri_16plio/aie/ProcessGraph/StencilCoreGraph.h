...
#define STENCIL_NUM_UNITS 16
#define STENCIL_INPUT_PORTS_PER_UNIT 3
#define STENCIL_TOTAL_CORES 48
...
private:
    ...
    static constexpr int flux2_tile_row(int lane) {
        return base_row(lane) + 2;
    }

    static_assert(STENCIL_NUM_UNITS * STENCIL_INPUT_PORTS_PER_UNIT ==
                  STENCIL_TOTAL_CORES);
    static_assert(STENCIL_NUM_UNITS == 16);
    static_assert(STENCIL_TOTAL_CORES == 48);
};
