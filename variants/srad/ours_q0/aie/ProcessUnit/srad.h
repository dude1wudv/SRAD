...
using srad_stats_input_buffer = input_buffer<
    float,
    adf::extents<srad_cfg::kStatsInputSampleElems>>;

using srad_stats_output_buffer = output_buffer<
    float,
    adf::extents<srad_cfg::kStatsOutputElems>>;
...
void srad_row_stats(srad_stats_input_buffer& in_j,
