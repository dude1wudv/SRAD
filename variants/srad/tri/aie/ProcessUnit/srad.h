...
using srad_row_input_buffer = input_buffer<
    float,
    adf::extents<adf::inherited_extent>>;
...
constexpr int kCenterQ2Plane = 0;
constexpr int kCenterValidPlane = 1;
constexpr int kSouthQ2Plane = 2;
constexpr int kSouthValidPlane = 3;
...
void srad_coeff_update(srad_mid_input_buffer& in_q2,
                       srad_update_input_buffer& in_j,
                       output_buffer<float>& out_j_next);

void srad_row_stats(srad_row_input_buffer& in_j_next,
