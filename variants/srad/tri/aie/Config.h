...
constexpr int kUpdatedRowPhysElems = kRowPhysElems;
constexpr int kStatsRowPhysElems = kRowPhysElems;
constexpr int kOutputRowPhysElems = kStatsRowPhysElems;
...
static_assert(kRowPhysElems == kRowDataElems + 3,
              "row stream keeps data plus three padding slots");
static_assert(kStatSumPadIndex == kRowDataElems,
              "K3 writes sum in the first output padding slot");
static_assert(kStatSum2PadIndex == kRowDataElems + 1,
              "K3 writes sum2 in the second output padding slot");
...
constexpr int kRowStatsTileRow = 2;
