...
constexpr const char* kBuildTag = "ours_96lane-6toppl-q0ctrl-20260623";
...
int main(int argc, char* argv[]) {
    ...
    try {
        ...
        auto toppl0 = open_kernel_cu(device, xrt_uuid, "TopPL", "TopPL_0");
        auto toppl1 = open_kernel_cu(device, xrt_uuid, "TopPL", "TopPL_1");
        auto toppl2 = open_kernel_cu(device, xrt_uuid, "TopPL", "TopPL_2");
        auto toppl3 = open_kernel_cu(device, xrt_uuid, "TopPL", "TopPL_3");
        auto toppl4 = open_kernel_cu(device, xrt_uuid, "TopPL", "TopPL_4");
        auto toppl5 = open_kernel_cu(device, xrt_uuid, "TopPL", "TopPL_5");
        ...
        auto image_bo =
            xrt::bo(device, srad_cfg::kBoardImageBytes, toppl0.group_id(0));
        auto output_bo =
            xrt::bo(device, srad_cfg::kBoardOutputBytes, toppl0.group_id(1));
        ...
        auto toppl0_run = toppl0(image_bo, output_bo, active_iters, 0);
        auto toppl1_run = toppl1(image_bo, output_bo, active_iters, 1);
        auto toppl2_run = toppl2(image_bo, output_bo, active_iters, 2);
        auto toppl3_run = toppl3(image_bo, output_bo, active_iters, 3);
        auto toppl4_run = toppl4(image_bo, output_bo, active_iters, 4);
        auto toppl5_run = toppl5(image_bo, output_bo, active_iters, 5);
