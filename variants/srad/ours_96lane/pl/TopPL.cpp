...
static_assert(srad_cfg::kTopPlWorkers == 6,
              "ours_96lane board path expects six TopPL CUs");
static_assert(srad_cfg::kTopPlColumnWorkers == 2,
              "ours_96lane board path expects two column workers per row block");
static_assert(srad_cfg::kBoardRowBlocks == 3,
              "ours_96lane board path expects three row blocks");
...
#pragma HLS bind_storage variable=to_aie_words0 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words1 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words2 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words3 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words4 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words5 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words6 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words7 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words8 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words9 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words10 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words11 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words12 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words13 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words14 type=fifo impl=lutram
#pragma HLS bind_storage variable=to_aie_words15 type=fifo impl=lutram
...
#pragma HLS DATAFLOW disable_start_propagation
    ...
    capture_output_words(in_j_next_0, from_aie_words0);
    forward_input_words(to_aie_words1, out_j_1);
    capture_output_words(in_j_next_1, from_aie_words1);
    forward_input_words(to_aie_words2, out_j_2);
    capture_output_words(in_j_next_2, from_aie_words2);
    forward_input_words(to_aie_words3, out_j_3);
    capture_output_words(in_j_next_3, from_aie_words3);
    forward_input_words(to_aie_words4, out_j_4);
    capture_output_words(in_j_next_4, from_aie_words4);
    forward_input_words(to_aie_words5, out_j_5);
    capture_output_words(in_j_next_5, from_aie_words5);
    forward_input_words(to_aie_words6, out_j_6);
    capture_output_words(in_j_next_6, from_aie_words6);
    forward_input_words(to_aie_words7, out_j_7);
    capture_output_words(in_j_next_7, from_aie_words7);
    forward_input_words(to_aie_words8, out_j_8);
    capture_output_words(in_j_next_8, from_aie_words8);
    forward_input_words(to_aie_words9, out_j_9);
    capture_output_words(in_j_next_9, from_aie_words9);
    forward_input_words(to_aie_words10, out_j_10);
    capture_output_words(in_j_next_10, from_aie_words10);
    forward_input_words(to_aie_words11, out_j_11);
    capture_output_words(in_j_next_11, from_aie_words11);
    forward_input_words(to_aie_words12, out_j_12);
    capture_output_words(in_j_next_12, from_aie_words12);
    forward_input_words(to_aie_words13, out_j_13);
    capture_output_words(in_j_next_13, from_aie_words13);
    forward_input_words(to_aie_words14, out_j_14);
    capture_output_words(in_j_next_14, from_aie_words14);
    forward_input_words(to_aie_words15, out_j_15);
    capture_output_words(in_j_next_15, from_aie_words15);
...
void run_worker_strip(const float* current,
                      ...
                      hls::stream<plio_word_t> in_j_next[srad_cfg::kLanesPerTopPl],
                      float q0sqr,
                      float& next_sum,
                      float& next_sum2) {
#pragma HLS INLINE off
