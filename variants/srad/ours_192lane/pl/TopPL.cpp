...
constexpr int kPacketHeaderWords = 1;
constexpr int kPacketPayloadWords32 = srad_cfg::kOutputRowPhysElems;
...
constexpr int kMergedOutputWordsPerTopPl =
    kStreamRowsPerLane * srad_cfg::kOutputMergeWays *
    (kPacketHeaderWords + kPacketPayloadWords32);
...
#pragma HLS PIPELINE II=1
                ...
                if (way == 0) {
                    from_aie_words0.write(payload);
                } else if (way == 1) {
                    from_aie_words1.write(payload);
                } else if (way == 2) {
                    from_aie_words2.write(payload);
                } else {
                    from_aie_words3.write(payload);
                }
            }
        }
    }
...
template<int Lane>
float buffered_input_value(float row_elems[kWorkerDataElems],
                           int physical_col,
                           bool valid_row,
                           float q0sqr) {
#pragma HLS INLINE
...
#pragma HLS PIPELINE II=1
                ...
                to_aie_words0.write(pack_two_floats(
                    row_elems[0 * srad_cfg::kRowDataElems + col0],
                    row_elems[0 * srad_cfg::kRowDataElems + col1]));
                to_aie_words1.write(pack_two_floats(
                    row_elems[1 * srad_cfg::kRowDataElems + col0],
                    row_elems[1 * srad_cfg::kRowDataElems + col1]));
                to_aie_words2.write(pack_two_floats(
                    row_elems[2 * srad_cfg::kRowDataElems + col0],
                    row_elems[2 * srad_cfg::kRowDataElems + col1]));
                to_aie_words3.write(pack_two_floats(
                    row_elems[3 * srad_cfg::kRowDataElems + col0],
                    row_elems[3 * srad_cfg::kRowDataElems + col1]));
                to_aie_words4.write(pack_two_floats(
                    row_elems[4 * srad_cfg::kRowDataElems + col0],
                    row_elems[4 * srad_cfg::kRowDataElems + col1]));
                to_aie_words5.write(pack_two_floats(
                    row_elems[5 * srad_cfg::kRowDataElems + col0],
                    row_elems[5 * srad_cfg::kRowDataElems + col1]));
                to_aie_words6.write(pack_two_floats(
                    row_elems[6 * srad_cfg::kRowDataElems + col0],
                    row_elems[6 * srad_cfg::kRowDataElems + col1]));
                to_aie_words7.write(pack_two_floats(
                    row_elems[7 * srad_cfg::kRowDataElems + col0],
                    row_elems[7 * srad_cfg::kRowDataElems + col1]));
                to_aie_words8.write(pack_two_floats(
                    row_elems[8 * srad_cfg::kRowDataElems + col0],
                    row_elems[8 * srad_cfg::kRowDataElems + col1]));
                to_aie_words9.write(pack_two_floats(
                    row_elems[9 * srad_cfg::kRowDataElems + col0],
                    row_elems[9 * srad_cfg::kRowDataElems + col1]));
                to_aie_words10.write(pack_two_floats(
                    row_elems[10 * srad_cfg::kRowDataElems + col0],
                    row_elems[10 * srad_cfg::kRowDataElems + col1]));
                to_aie_words11.write(pack_two_floats(
                    row_elems[11 * srad_cfg::kRowDataElems + col0],
                    row_elems[11 * srad_cfg::kRowDataElems + col1]));
                to_aie_words12.write(pack_two_floats(
                    row_elems[12 * srad_cfg::kRowDataElems + col0],
                    row_elems[12 * srad_cfg::kRowDataElems + col1]));
                to_aie_words13.write(pack_two_floats(
                    row_elems[13 * srad_cfg::kRowDataElems + col0],
                    row_elems[13 * srad_cfg::kRowDataElems + col1]));
                to_aie_words14.write(pack_two_floats(
                    row_elems[14 * srad_cfg::kRowDataElems + col0],
                    row_elems[14 * srad_cfg::kRowDataElems + col1]));
                to_aie_words15.write(pack_two_floats(
                    row_elems[15 * srad_cfg::kRowDataElems + col0],
                    row_elems[15 * srad_cfg::kRowDataElems + col1]));
            }

            to_aie_words0.write(pack_two_floats(
                row_elems[0 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words1.write(pack_two_floats(
                row_elems[1 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words2.write(pack_two_floats(
                row_elems[2 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words3.write(pack_two_floats(
                row_elems[3 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words4.write(pack_two_floats(
                row_elems[4 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words5.write(pack_two_floats(
                row_elems[5 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words6.write(pack_two_floats(
                row_elems[6 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words7.write(pack_two_floats(
                row_elems[7 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words8.write(pack_two_floats(
                row_elems[8 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words9.write(pack_two_floats(
                row_elems[9 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words10.write(pack_two_floats(
                row_elems[10 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words11.write(pack_two_floats(
                row_elems[11 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words12.write(pack_two_floats(
                row_elems[12 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words13.write(pack_two_floats(
                row_elems[13 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words14.write(pack_two_floats(
                row_elems[14 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));
            to_aie_words15.write(pack_two_floats(
                row_elems[15 * srad_cfg::kRowDataElems + kLastDataPhysicalCol],
                q0sqr));

            to_aie_words0.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words1.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words2.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words3.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words4.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words5.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words6.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words7.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words8.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words9.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words10.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words11.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words12.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words13.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words14.write(pack_two_floats(0.0f, 0.0f));
            to_aie_words15.write(pack_two_floats(0.0f, 0.0f));
        } else {
...
#pragma HLS ARRAY_PARTITION variable=lane_sum2 complete dim=1
    ...
    hls::stream<plio_word_t> from_aie_words14;
    hls::stream<plio_word_t> from_aie_words15;
#pragma HLS STREAM variable=lane_stat0 depth=1
#pragma HLS STREAM variable=lane_stat1 depth=1
#pragma HLS STREAM variable=lane_stat2 depth=1
#pragma HLS STREAM variable=lane_stat3 depth=1
#pragma HLS STREAM variable=lane_stat4 depth=1
#pragma HLS STREAM variable=lane_stat5 depth=1
#pragma HLS STREAM variable=lane_stat6 depth=1
#pragma HLS STREAM variable=lane_stat7 depth=1
#pragma HLS STREAM variable=lane_stat8 depth=1
#pragma HLS STREAM variable=lane_stat9 depth=1
#pragma HLS STREAM variable=lane_stat10 depth=1
#pragma HLS STREAM variable=lane_stat11 depth=1
#pragma HLS STREAM variable=lane_stat12 depth=1
#pragma HLS STREAM variable=lane_stat13 depth=1
#pragma HLS STREAM variable=lane_stat14 depth=1
#pragma HLS STREAM variable=lane_stat15 depth=1
#pragma HLS STREAM variable=to_aie_words0 depth=16
#pragma HLS STREAM variable=to_aie_words1 depth=16
#pragma HLS STREAM variable=to_aie_words2 depth=16
#pragma HLS STREAM variable=to_aie_words3 depth=16
#pragma HLS STREAM variable=to_aie_words4 depth=16
#pragma HLS STREAM variable=to_aie_words5 depth=16
#pragma HLS STREAM variable=to_aie_words6 depth=16
#pragma HLS STREAM variable=to_aie_words7 depth=16
#pragma HLS STREAM variable=to_aie_words8 depth=16
#pragma HLS STREAM variable=to_aie_words9 depth=16
#pragma HLS STREAM variable=to_aie_words10 depth=16
#pragma HLS STREAM variable=to_aie_words11 depth=16
#pragma HLS STREAM variable=to_aie_words12 depth=16
#pragma HLS STREAM variable=to_aie_words13 depth=16
#pragma HLS STREAM variable=to_aie_words14 depth=16
#pragma HLS STREAM variable=to_aie_words15 depth=16
#pragma HLS bind_storage variable=to_aie_words0 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words1 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words2 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words3 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words4 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words5 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words6 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words7 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words8 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words9 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words10 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words11 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words12 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words13 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words14 type=fifo impl=srl
#pragma HLS bind_storage variable=to_aie_words15 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words0 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words1 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words2 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words3 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words4 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words5 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words6 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words7 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words8 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words9 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words10 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words11 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words12 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words13 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words14 type=fifo impl=srl
#pragma HLS bind_storage variable=from_aie_words15 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat0 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat1 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat2 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat3 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat4 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat5 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat6 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat7 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat8 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat9 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat10 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat11 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat12 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat13 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat14 type=fifo impl=srl
#pragma HLS bind_storage variable=lane_stat15 type=fifo impl=srl
#pragma HLS STREAM variable=from_aie_words0 depth=64
#pragma HLS STREAM variable=from_aie_words1 depth=64
#pragma HLS STREAM variable=from_aie_words2 depth=64
#pragma HLS STREAM variable=from_aie_words3 depth=64
#pragma HLS STREAM variable=from_aie_words4 depth=64
#pragma HLS STREAM variable=from_aie_words5 depth=64
#pragma HLS STREAM variable=from_aie_words6 depth=64
#pragma HLS STREAM variable=from_aie_words7 depth=64
#pragma HLS STREAM variable=from_aie_words8 depth=64
#pragma HLS STREAM variable=from_aie_words9 depth=64
#pragma HLS STREAM variable=from_aie_words10 depth=64
#pragma HLS STREAM variable=from_aie_words11 depth=64
#pragma HLS STREAM variable=from_aie_words12 depth=64
#pragma HLS STREAM variable=from_aie_words13 depth=64
#pragma HLS STREAM variable=from_aie_words14 depth=64
#pragma HLS STREAM variable=from_aie_words15 depth=64
...
#pragma HLS DATAFLOW disable_start_propagation
    ...
    forward_input_words(to_aie_words1, out_j_1);
    capture_merged_output_packets(in_j_next_0,
                                  from_aie_words0,
                                  from_aie_words1,
                                  from_aie_words2,
                                  from_aie_words3);
    forward_input_words(to_aie_words2, out_j_2);
    forward_input_words(to_aie_words3, out_j_3);
    forward_input_words(to_aie_words4, out_j_4);
    forward_input_words(to_aie_words5, out_j_5);
    capture_merged_output_packets(in_j_next_1,
                                  from_aie_words4,
                                  from_aie_words5,
                                  from_aie_words6,
                                  from_aie_words7);
    forward_input_words(to_aie_words6, out_j_6);
    forward_input_words(to_aie_words7, out_j_7);
    forward_input_words(to_aie_words8, out_j_8);
    forward_input_words(to_aie_words9, out_j_9);
    capture_merged_output_packets(in_j_next_2,
                                  from_aie_words8,
                                  from_aie_words9,
                                  from_aie_words10,
                                  from_aie_words11);
    forward_input_words(to_aie_words10, out_j_10);
    forward_input_words(to_aie_words11, out_j_11);
    forward_input_words(to_aie_words12, out_j_12);
    forward_input_words(to_aie_words13, out_j_13);
    capture_merged_output_packets(in_j_next_3,
                                  from_aie_words12,
                                  from_aie_words13,
                                  from_aie_words14,
                                  from_aie_words15);
    forward_input_words(to_aie_words14, out_j_14);
