...
constexpr int kRawNorthPlane = srad_cfg::kRawRowStartPlane + 0;
constexpr int kRawCenterPlane = srad_cfg::kRawRowStartPlane + 1;
constexpr int kRawSouthPlane = srad_cfg::kRawRowStartPlane + 2;
