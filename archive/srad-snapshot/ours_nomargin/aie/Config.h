...
constexpr int kCoeffPlanesPerRow = 4;
constexpr int kRawRowsPerMidPacket = 3;
constexpr int kRawRowStartPlane = kCoeffPlanesPerRow;
constexpr int kMidRecordElems = kCoeffPlanesPerRow + kRawRowsPerMidPacket;
...
static_assert((kMidBytesPerRow % 16) == 0,
              "K1->K2 packet size must be 16-byte aligned");
