...
constexpr int kQ0DebugBase = srad_cfg::kOutputElems + srad_cfg::kTopPlWorkers;

static_assert(srad_cfg::kTopPlWorkers == 1,
              "row-stream Q0Ctrl expects one TopPL worker");
